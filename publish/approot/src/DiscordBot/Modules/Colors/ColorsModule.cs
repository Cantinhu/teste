		...
		void IModule.Install(ModuleManager manager)
		{
            ...
            manager.CreateCommands("colors", group =>
            {
                ...
                group.CreateCommand("set")
                    ...
                    .Do(async e =>
                    {
                        if (serversettings.iscommandenabled(e.Server.Id.ToString(), "colors"))
                            await SetColor(e, e.User, e.Args[0]);
                        else
                            await _client.Reply(e, "This command is disabled.");
                    });
                ...
                group.CreateCommand("set")
					...
					.Do(async e =>
					{
                        ...
                        { 
                            ...
                            await SetColor(e, user, e.Args[1]);
                        }
                        else
                            await _client.Reply(e, "This command is disabled.");
                    });
